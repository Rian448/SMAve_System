...
export default function InventoryPage() {
  ...
  const [editingItem, setEditingItem] = useState<RawMaterial | FinishedGood | null>(null);
  ...
  const fetchInventory = async () => {
    ...
    try {
      if (activeTab === 'raw-materials') {
        const data = await api.inventory.getRawMaterials();
        setRawMaterials(data);
      } else if (activeTab === 'finished-goods') {
        const data = await api.inventory.getFinishedGoods();
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          ...
          <div className="mt-4 sm:mt-0 flex gap-3">
            <Link
              ...
              className="inline-flex items-center px-4 py-2 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-lg font-medium hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
            >
                        ...
                        <tr key={material.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right">
                            <button
                              ...
                              className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 text-sm font-medium mr-3"
                            >
                              Edit
                            </button>
                            <button
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">
                  {rawMaterials.filter(m => m.quantity <= m.reorderLevel && m.quantity > 0).length}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">
                  {formatCurrency(rawMaterials.reduce((sum, m) => sum + (m.quantity * m.unitPrice), 0))}
                </p>
              </div>
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Inventory</h1>
        ...
        {showModal && (
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              <div className="fixed inset-0 bg-zinc-500 bg-opacity-75 transition-opacity" onClick={() => setShowModal(false)} />
              ...
              <div className="inline-block align-bottom bg-white dark:bg-zinc-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="mt-1 block w-full rounded-md border-zinc-300 dark:border-zinc-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-zinc-700 dark:text-white px-3 py-2"
                        />
                      </div>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Supplier</label>
                        <input
                          type="text"
                          required
                  ...
                  <div className="bg-zinc-50 dark:bg-zinc-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button
                      type="submit"
                    ...
                    <button
                      ...
                      className="mt-3 w-full inline-flex justify-center rounded-md border border-zinc-300 dark:border-zinc-600 shadow-sm px-4 py-2 bg-white dark:bg-zinc-800 text-base font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                    >
                      Cancel
                    </button>
                  </div>
