      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
          ...
          <div className="relative">
            ...
            {/* Progress line */}
            <div className="absolute top-6 sm:top-8 left-6 sm:left-8 right-6 sm:right-8 h-0.5 bg-gray-200 -z-0">
              <div 
                className="h-full bg-[#011c72] transition-all duration-500"
                style={{
        ...
        <div className="mt-6 flex flex-wrap gap-2 sm:gap-3">
          <button 
            ...
            className="inline-flex items-center px-3 sm:px-4 py-2 bg-white border border-gray-200 hover:border-[#011c72] text-gray-700 text-sm sm:text-base rounded-lg font-medium transition-colors"
          >
          ...
          <button className="inline-flex items-center px-3 sm:px-4 py-2 bg-white border border-gray-200 hover:border-[#011c72] text-gray-700 text-sm sm:text-base rounded-lg font-medium transition-colors">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {delivery.status !== 'delivered' && delivery.status !== 'cancelled' && (
            <button
              ...
              disabled={updating}
              className="inline-flex items-center px-3 sm:px-4 py-2 bg-red-50 border border-red-200 hover:bg-red-100 text-red-600 text-sm sm:text-base rounded-lg font-medium transition-colors disabled:opacity-50"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
