    ...
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  period === p
                    ...
                    : 'bg-white text-gray-600 border border-gray-200 hover:border-[#011c72]'
                }`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {analytics?.categoryDistribution.map((category) => (
                <div key={category.name}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
                      className="bg-[#011c72] h-2.5 rounded-full"
                      style={{
            ...
            <div className="space-y-3">
              {analytics?.topMaterials.map((material, index) => (
                <div key={material.name} className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-semibold text-[#011c72]">
          ...
          <div className="bg-white shadow-sm rounded-xl border border-gray-200 p-6 lg:col-span-2">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">
              Monthly Trends
            </h2>
            <div className="mt-6">
                ...
                {analytics?.monthlyTrends.map((trend) => (
                  <div key={trend.month} className="flex-1 flex flex-col items-center">
                    <div className="w-full flex justify-center items-end space-x-1 h-48">
                      ...
                      <div className="flex flex-col items-center flex-1">
                        <div
                          className="w-full bg-[#011c72] rounded-t-md transition-all hover:bg-[#011c72]"
                          style={{
              ...
              <div className="flex justify-center mt-6 space-x-6">
                ...
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-[#011c72] rounded mr-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-green-50 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="text-sm font-medium text-green-800">Sales Trend</h3>
                </div>
                <p className="text-xs text-green-600">
                  Sales have increased by 15% compared to last month. Full Upholstery remains the top service.
                </p>
              </div>
              <div className="bg-[#eef1fb] rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <svg className="w-5 h-5 text-[#011c72] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                  <h3 className="text-sm font-medium text-[#011c72]">Inventory Alert</h3>
                </div>
                <p className="text-xs text-[#011c72]">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="text-sm font-medium text-blue-800">Performance</h3>
                </div>
