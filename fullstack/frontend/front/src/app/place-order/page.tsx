      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'appointment' && (
          <form onSubmit={handleAppointmentSubmit} className="max-w-2xl mx-auto space-y-6">
            ...
            {!loadingBranches && branches.some(b => b.phone) && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-base font-semibold text-gray-900">Branch Contact Numbers</h2>
                </div>
                <div className="space-y-2">
                  {branches.filter(b => b.phone).map(b => (
                    <div key={b.id} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                      ...
                      <a href={`tel:${b.phone}`} className="text-sm text-[#011c72] font-semibold hover:underline">{b.phone}</a>
                    </div>
                  ))}
                </div>
              </div>
